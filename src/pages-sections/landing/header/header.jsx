          ...
          <Container maxWidth="lg">
            <FlexBox height={HEADER_HEIGHT} alignItems="center">
              ...
              <FlexBox className="right-links" alignItems="center">
                <Scroll to="features" smooth={true} duration={SCROLL_DURATION} offset={SCROLL_OFFSET}>
              ...
              {downSM ? <SideNav open={open} width={260} position="right" toggle={toggleSidenav} handler={handle => <IconButton onClick={handle}>
                ...
                "& .link": {
                  ...
                  "&:hover": {
                    ...
                    <Scroll to="features" duration={SCROLL_DURATION} offset={SCROLL_OFFSET} smooth={true}>
                    ...
                    <Scroll smooth={true} to="technologies" offset={SCROLL_OFFSET} duration={SCROLL_DURATION}>
