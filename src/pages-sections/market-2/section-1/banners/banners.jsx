...
export default function Banners() {
  return <Stack spacing={3} height="100%" direction={{
    lg: "column",
    sm: "row",
    xs: "column"
  }}>
...
function BannerContent({
  ...
  return <div className="content">
      <Typography variant="body1" fontWeight={500} lineHeight={1} sx={{
      mb: 1
    }}>
        {tag}
      </Typography>

      <Typography variant="body1" lineHeight={1.3} fontWeight={700} fontSize={{
      sm: 24,
      xs: 22
    }} sx={{
      maxWidth: {
