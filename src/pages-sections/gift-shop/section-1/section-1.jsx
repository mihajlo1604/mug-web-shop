  ...
  return <StyledRoot>
      <Container>
        <div className="carousel-wrapper">
          ...
          <CarouselDots scrollSnaps={dots.scrollSnaps} selectedIndex={dots.selectedIndex} onDotButtonClick={dots.onDotButtonClick} dotColor={theme.palette.primary[300]} sx={{
          position: "absolute",
          bottom: 20,
          left: 0,
          right: 0
