...
export default async function GroceryOnePageView({
  ...
  const [products, popularProducts, trendingProducts, grocery1NavList] = await Promise.all([api.getProducts(selected), api.getPopularProducts(), api.getTrendingProducts(), api.getGrocery1Navigation()]);
