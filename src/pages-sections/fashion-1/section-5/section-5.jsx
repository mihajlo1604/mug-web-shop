...
export default async function Section5() {
  ...
  return <Container className="pb-4">
      <ContentWrapper>
        <CarouselCard buttonText="BUY NOW" imgUrl={item.imgUrl} productName={item.productName} offerName={item.offerName} offerTagline={item.offerTagline} offerDescription={item.offerDescription} expireDate={new Date(item.expireDate).getTime()} />
