  ...
  return <Container>
      <Grid container spacing={3} mt={6}>
        ...
        xs: 12
          ...
          <Banner2 isContentCenter title="Sofa style  2024" ImageComponent={<LazyImage src={banner2} alt="banner" />} />
        </Grid>
        ...
        xs: 12
          ...
          <Banner2 title="Sale up to  30% off" ImageComponent={<LazyImage src={banner4} alt="banner" />} />
        </Grid>
      </Grid>
    </Container>;
}