...
export default function DeliveryAddresses({
  ...
  const HeaderSection = <FlexBetween mb={4}>
  ...
  return <Card>
      ...
      <Grid container spacing={2}>
        {deliveryAddresses.map((address, ind) => <Grid size={{
        md: 4,
        sm: 6,
        xs: 12
      }} key={ind}>
        ...
        }) => <AddressItem address={address} isSelected={address.street1 === field.value} hasError={Boolean(error)} onSelect={field.onChange} onEdit={handleEditDeliveryAddress} onDelete={handleDeleteDeliveryAddress} />} />
          </Grid>)}
      </Grid>
