...
export default async function GroceryTwoPageView() {
  const [dairyProducts, navigationList, mainCarouselData, featuredProducts, bestHomeProducts, bestSellProducts] = await Promise.all([api.getDairyProducts(), api.getNavigationList(), api.getMainCarousel(), api.getFeaturedProducts(), api.getBestHomeProducts(), api.getBestSellProducts()]);
