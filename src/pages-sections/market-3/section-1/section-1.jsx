      ...
      <Grid container spacing={2}>
        ...
        md: 9
          ...
          <Carousel ref={ref} api={api} options={options}>
            {carouselData.map((item, ind) => <CarouselCard key={ind} mode="light" discount={10} title={item.title} bgImage={item.imgUrl} buttonText="Shop Now" category={item.category} buttonLink={item.buttonLink} description={item.description} />)}
          </Carousel>
        </Grid>
        ...
        md: 3
          ...
          xs: "column"
            ...
            <BannerCard imageFull flex={1} img="/assets/images/banners/banner-17.jpg" maxHeight={240}>
              ...
              <Typography variant="h4" fontSize={20} fontWeight={700} sx={{
              mb: 2
            }}>
                SUMMER
                <br />
