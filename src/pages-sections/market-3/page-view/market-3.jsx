...
export default async function MarketThreePageView() {
  const [mainCarouselData, menFashionProducts, electronicsProducts, womenFashionProducts] = await Promise.all([api.getMainCarouselData(), api.getMenFashionProducts(), api.getElectronicsProducts(), api.getWomenFashionProducts()]);
  return <Fragment>
