      ...
      <Grid container spacing={3}>
        ...
        sm: 1
          ...
          <ContentWrapper>
            <Box padding={4} pb={0}>
              ...
              <IconLink title="Explore Now" url="#" sx={{
              color: "white"
            }} />
            </Box>

            <LazyImage quality={90} loading="lazy" alt="Iphone 14" src={iphone14} sx={{
            display: "block"
          }} />
          </ContentWrapper>
        </Grid>
        ...
        sm: 2
          ...
          <ContentWrapper hasGradient>
            <LazyImage quality={90} loading="lazy" alt="Nikon Camera" src={nikonCamera} style={{
            marginTop: -70
          }} />
            ...
            <Box px={4} py={2}>
              ...
              <Typography variant="body1" fontWeight={700} fontSize={{
              xl: 55,
              md: 42,
              sm: 36,
              xs: 28
        ...
        xs: 12
          ...
          <ContentWrapper>
            ...
            xs: 0
              ...
              <Typography variant="body1" fontWeight={700} lineHeight={1.2} fontSize={{
              xl: 40,
              md: 32,
              xs: 28
            }} sx={{
        ...
        xs: 12
          ...
          bgcolor: "grey.700"
            ...
            <Box padding={4} pb={2}>
              ...
              <Typography variant="h2" lineHeight={1.2} fontWeight={700} fontSize={{
              xl: 45,
              md: 32,
              xs: 28
            }} sx={{
            ...
            <Box px={8}>
              <LazyImage alt="Iphone 14" loading="lazy" quality={90} src={appleAirPod} style={{
              display: "block"
            }} />
            </Box>
          </ContentWrapper>
        ...
        xs: 12
          ...
          justifyContent: "space-between"
            ...
            <LazyImage quality={90} loading="lazy" alt="Iphone 12" src={iphone12} sx={{
            display: "block"
          }} />
          </ContentWrapper>
        </Grid>
