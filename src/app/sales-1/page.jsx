...
export default async function SalesOne({
  ...
  return <SalesOnePageView page={currentPage} categories={categories} products={data.products} pageSize={data.pageSize} totalProducts={data.totalProducts} discount="Enjoy Upto 80% discounts" offer="Flash Deals," />;
}