...
export default function DropZone({
  ...
  return <Box py={6} px={{
    md: 10,
    xs: 4
  }} display="flex" minHeight="200px" textAlign="center" alignItems="center" borderRadius="10px" border="1.5px dashed" flexDirection="column" borderColor="divider" justifyContent="center" bgcolor={isDragActive ? "grey.100" : "grey.50"} sx={{
