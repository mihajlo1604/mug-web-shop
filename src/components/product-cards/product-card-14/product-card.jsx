  ...
  return <StyledRoot>
      <Link href={`/products/${slug}`}>
        <div className="img-wrapper">
          ...
          <Image fill alt={title} src={thumbnail} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={75} />
        </div>
      </Link>

      <Content>
        <Rating readOnly size="small" value={rating} icon={<Star fontSize="inherit" />} emptyIcon={<Star fontSize="inherit" />} />
