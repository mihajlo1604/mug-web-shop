...
export default function ImageCarousel({
  ...
  return <>
      ...
      <StyledButtonBase className="prev-btn" disabled={arrows.disablePrev} onClick={arrows.onClickPrev} sx={{
      left: 5
    }}>
        <SvgIcon>
      ...
      <StyledButtonBase className="next-btn" disabled={arrows.disableNext} onClick={arrows.onClickNext} sx={{
      right: 5
    }}>
        <SvgIcon>
